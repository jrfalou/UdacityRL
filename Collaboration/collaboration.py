...
def create_results_folders(filepath):
    results_path = os.path.join('./Results', os.path.dirname(filepath))
    if not os.path.exists(results_path):
        print('create_results_folders', results_path)
        os.mkdir(results_path)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Parameters for collaboration project')
